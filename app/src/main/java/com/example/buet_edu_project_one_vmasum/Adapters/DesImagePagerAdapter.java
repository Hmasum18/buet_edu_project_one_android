...
public class DesImagePagerAdapter extends PagerAdapter {

    public static final String TAG = "DesImagePagerAdapter:";
    Context context;
    int idx;
    private Problem problem;

    public DesImagePagerAdapter(Context context,int idx)
    {
...
//        problem = RunTimeDB.getInstance().getProblems().get(idx);
    ...
    @Override
    public int getCount() {
        Log.d(TAG," getcount: "+problem.getDes_images().size());
        return problem.getDes_images().size();
    }
    ...
    public Object instantiateItem(@NonNull ViewGroup container, int position) {
        ArrayList<String> des_image = problem.getDes_images();
